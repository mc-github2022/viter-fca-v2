        ...
        >
          ...
          <div className="bg-primary border border-line rounded-md max-w-[1100px] w-full overflow-x-auto ">
            <div className="flex gap-10 relative">
              ...
              <main className="setting__main p-4 relative">
                <button className="absolute top-5 left-4 text-xl">
                  <FaBars />
                </button>
                <h2 className="mb-3 flex gap-3 items-center ml-8">
                  Department
                </h2>
                ...
                <div className="datalist mb-10 max-h-[200px] h-full overflow-hidden overflow-y-auto custom__scroll">
