...
const StudentParentConsent = ({ showSideNav, itemEdit, gradelevel }) => {
  ...
  const initVal = {
    ...
    current_students_last_parent_consent_is_agree:
      itemEdit.current_students_last_parent_consent_is_agree === 0
        ? false
        : true,
  };
                  ...
                  <div className="mb-14 text-xs">
                    ...
                    <div className="form__wrap flex items-center gap-2 ">
                      <InputCheckbox
                        ...
                        name="current_students_last_parent_consent_is_agree"
                        id="current_students_last_parent_consent_is_agree"
                      />
                    </div>
                  </div>
                </div>
