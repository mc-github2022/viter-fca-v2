...
const StudentParentCommitment = ({ showSideNav, itemEdit, gradelevel }) => {
  ...
  const initVal = {
    ...
    school_year_students_last_parent_commitment_is_agree:
      itemEdit.school_year_students_last_parent_commitment_is_agree === "" ||
      itemEdit.school_year_students_last_parent_commitment_is_agree === 0
        ? false
        : true,
  };
                  ...
                  <div className="mb-14 text-xs">
                    ...
                    <div className="form__wrap flex items-center gap-2 ">
                      <InputCheckbox
                        ...
                        name="school_year_students_last_parent_commitment_is_agree"
                        id="school_year_students_last_parent_commitment_is_agree"
                      />
                    </div>
                  </div>
                </div>
