  ...
  return (
    <>
      <aside
        ...
        } modal__settings__nav z-10 ease-timing-nav   top-[40px] h-[calc(100%-40px)] lg:h-full w-[195px]  absolute lg:relative lg:top-0 border-r border-line transition-all duration-300`}
      >
