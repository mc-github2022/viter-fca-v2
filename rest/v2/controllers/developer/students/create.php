...
$student->student_info_learning_type = $data["student_info_learning_type"];
...
$student->student_info_landline = $data["student_info_landline"];
 $student->student_info_adress_id = checkIndex($data, "student_info_adress_id");
