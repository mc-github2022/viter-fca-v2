  ...
  return (
    <>
      <div className="h-screen w-full relative">
        <div className="login w-full max-w-[380px] border border-gray-200 py-10 px-8 absolute left-[50%] translate-x-[-50%] top-20 md:top-40  rounded-md shadow-sm  -translate-y-14 bg-primary">
          {isSuccess ? (
            <>
