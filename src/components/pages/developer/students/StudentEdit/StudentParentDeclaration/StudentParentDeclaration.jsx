...
const StudentParentDeclaration = ({
  setIsViewInfo,
  showSideNav,
  dataItem,
  gradeLevel,
  ...
  const initVal = {
    ...
    school_year_students_last_parent_declaration_is_agree:
      dataItem.school_year_students_last_parent_declaration_is_agree === "" ||
      dataItem.school_year_students_last_parent_declaration_is_agree === 0
        ? false
        : true,
  };
